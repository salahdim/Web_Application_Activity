<%@ Page Title="" Language="C#" MasterPageFile="~/Tableau_De_Bord/Details.Master" AutoEventWireup="true" CodeBehind="Z02.aspx.cs" Inherits="Web_Application_Activity.Tableau_De_Bord.Z02" %>
       ...
       <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          <a href="../../Tableau_De_Bord/TableauDeBord.aspx" >
            ...
            <li class="active"><a href="../../Tableau_De_Bord/Z02.aspx"><i class="fa fa-circle-o"></i> <asp:Label ID="LabelT2" runat="server" Text="t2"></asp:Label></a></li>
            ...
            <div class="box-body">
              <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                  ...
                  <div class="item">
                   <img src="http://placehold.it/1650x250/39CCCC/ffffff&text=tableau+de+<% = z02 %>" alt="Troisième diapositive">
...
<asp:Content ID="Content3" ContentPlaceHolderID="tableNom" runat="server">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><asp:Label ID="LabelZ02" runat="server" Text="Label"></asp:Label></li>
      </ol>
    </section>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form id="form2" runat="server">
        <asp:DataGrid ID="DataGrid2" runat="server" PageSize="20" AllowPaging="True" 
