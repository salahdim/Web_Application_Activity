...
{
    public partial class Z06 : System.Web.UI.Page
    {
        String name;
        String userName;
        ...
        protected void BindData()
        {
            ...
            if (!this.IsPostBack)
            {
                ...
                {
                    using (MySqlCommand cmd = new MySqlCommand("SELECT * FROM database.titre WHERE titre.codeuser='" + Session["urole"] + "' AND titre.numzone='C32' UNION SELECT * FROM database.detail WHERE detail.codeuser='" + Session["urole"] + "' AND detail.numzone='C32' "))
                    {
