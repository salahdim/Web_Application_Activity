<%@ Page Title="" Language="C#" MasterPageFile="~/Tableau_De_Bord/Details.Master" AutoEventWireup="true" CodeBehind="Z01.aspx.cs" Inherits="Web_Application_Activity.Tableau_De_Bord.Z01" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="tableNom" runat="server">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><asp:Label ID="LabelZ01" runat="server" Text="Label"></asp:Label></li>
      </ol>
    </section>
...
<asp:Content ID="Content7" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form id="form11" runat="server">
        <asp:DataGrid ID="DataGrid1" runat="server" PageSize="20" AllowPaging="True" 
...
<asp:Content ID="Content8" ContentPlaceHolderID="nav_menu" runat="server">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          <a href="../../Tableau_De_Bord/TableauDeBord.aspx" >
            ...
            <li class="active"><a href="../../Tableau_De_Bord/Z01.aspx"><i class="fa fa-circle-o"></i><asp:Label ID="LabelT1" runat="server" Text="t1"></asp:Label> </a></li>
            ...
            <li><a href="../../Tableau_De_Bord/Z07.aspx"><i class="fa fa-circle-o"></i><asp:Label ID="LabelT7" runat="server" Text="t7"></asp:Label> </a></li>
            ...
            <div class="box-body">
              <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                  ...
                  <div class="item">
                   <img src="http://placehold.it/1650x250/39CCCC/ffffff&text=tableau+de+<% = z01 %>" alt="Troisième diapositive">
