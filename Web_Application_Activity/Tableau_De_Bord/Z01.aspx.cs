...
{
    public partial class Z01 : System.Web.UI.Page
    {
        public String nom;
        ...
        protected void BindData()
        {
            ...
            if (!this.IsPostBack)
            {
                ...
                {
                    using (MySqlCommand cmd = new MySqlCommand("SELECT * FROM database.titre WHERE titre.codeuser='" + Session["urole"] + "' AND titre.numzone='C11' UNION SELECT * FROM database.detail WHERE detail.codeuser='" + Session["urole"] + "' AND detail.numzone='C11' "))
                    {
