<%@ Page Title="" Language="C#" MasterPageFile="~/Tableau_De_Bord/Details.Master" AutoEventWireup="true" CodeBehind="Z08.aspx.cs" Inherits="Web_Application_Activity.Tableau_De_Bord.Z08" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentHeader" runat="server">
              ...
              <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                  ...
                  <div class="item">
                   <img src="http://placehold.it/1650x250/39CCCC/ffffff&text=tableau+de+<% = z08 %>" alt="Troisième diapositive">
      ...
      <!-- sidebar menu: : style can be found in sidebar.less -->
       ...
       <li class="active treeview">
          <a href="../../Tableau_De_Bord/TableauDeBord.aspx" >
            ...
            <li class="active"><a href="../../Tableau_De_Bord/Z08.aspx"><i class="fa fa-circle-o"></i> <asp:Label ID="LabelT8" runat="server" Text="t8"></asp:Label></a></li>
...
<asp:Content ID="Content3" ContentPlaceHolderID="tableNom" runat="server">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><asp:Label ID="LabelZ08" runat="server" Text="Label"></asp:Label></li>
      </ol>
    </section>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form id="form2" runat="server">
        <asp:DataGrid ID="DataGrid8" runat="server" PageSize="20" AllowPaging="True" 
