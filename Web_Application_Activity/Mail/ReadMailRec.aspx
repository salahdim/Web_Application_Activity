<%@ Page Title="" Language="C#" MasterPageFile="~/Mail/Mail.Master" AutoEventWireup="true" CodeBehind="ReadMailRec.aspx.cs" Inherits="Web_Application_Activity.Mail.ReadMailRec" %>
       ...
       <li>
        ...
        <li class="active treeview">
          <a href="#" class="active">
            ...
            <li class="active"><a href="../Mail/Inbox.aspx"><i class="fa fa-circle-o"></i> Boîte de réception</a></li>
            ...
            <div class="box-footer">
              ...
              <ul class="mailbox-attachments clearfix">
                ...
                <li>
                  ...
                  <span class="mailbox-attachment-icon has-img"><asp:Image ID="Image2" runat="server"  ImageUrl="http://www.dogsleds.ca/images/non-disponible.png" AlternateText="Attachment" /></span>
    ...
    <Columns>
        ...
        <asp:TemplateField ItemStyle-HorizontalAlign="Center">
            ...
            <ItemTemplate>
                ...
                <asp:LinkButton ID="lnkView" runat="server" Text="Afficher" OnClick="View" CommandArgument='<%# Eval("id") %>'></asp:LinkButton>
...
<div>
    <asp:Literal ID="ltEmbed" runat="server" />
            ...
            <div class="box-footer">
                ...
                <asp:Button runat="server"  OnClick="DoSQLQueryDelete" Text="Supprimer"  class="btn btn-default" ></asp:Button>
            </div>
            <!-- /.box-footer -->
          </div>
          <!-- /. box -->
