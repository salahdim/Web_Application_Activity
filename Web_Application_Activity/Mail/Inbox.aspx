<%@ Page Title="" Language="C#" MasterPageFile="~/Mail/Mail.Master" AutoEventWireup="true" CodeBehind="Inbox.aspx.cs" Inherits="Web_Application_Activity.Mail.Inbox" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content">
      <div class="row">
            ...
            <div class="box-header with-border">
             ...
             <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="../Mail/Inbox.aspx" ><i class="fa fa-inbox"></i> Boîte de réception
        ...
        <asp:DataGrid ID="MyDataGridRec" runat="server"
                OnItemCommand="maGrille_ItemCommand1"            
                PageSize="5000"
                ForeColor="#333333"
                GridLines="Vertical"
           ...
           >
            ...
            <Columns  >
                    ...
                    <asp:BoundColumn HeaderText="Etat"  DataField="estLu">
                    </asp:BoundColumn>
                    </Columns>
